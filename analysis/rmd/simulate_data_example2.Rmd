...
params:
  ...
  percent_train:
    input: numeric
    label: "What proportion of total number of samples should be used for training?"
    value: 0.5
  percent_holdout:
    input: numeric
    label: "What proportion of total number of samples should be used for holdout?"
    value: 0.5
  percent_validation:
    input: numeric
    label: "What proportion of total number of samples should be used for validation?"
    value: 0
  class_label:
    input: text
...
```{r interactionFig, fig.align = "center", out.width = "80%", fig.cap = figures("interactionFig"), fig.id=FALSE}
...
```{r visualize-effects, fig.align = "center", out.width = "80%"}
