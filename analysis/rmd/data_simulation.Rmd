...
## Standard Univariate Statistics for Detecting Main Effects {.tabset}

### t-test
```{r}
create_stat_tab(.data = sim.dats, test.name = "t-test", response.name = "class") |> 
...
```{r}
create_stat_tab(.data = sim.dats, test.name = "ks-test", response.name = "class") |> 
  format_stat_tab(n.digits = 3) |> 
  create_html_DT()
```
...
```{r}
create_stat_tab(.data = sim.dats, test.name = "wilcox-test", response.name = "class") |> 
  format_stat_tab(n.digits = 3) |> 
  create_html_DT()
```
...
create_stat_tab(.data = sim.dats, test.name = "kw-test", response.name = "class") |> 
  format_stat_tab(n.digits = 3) |> 
  create_html_DT()
```
...
create_stat_tab(.data = sim.dats, test.name = "lm-test", response.name = "class") |> 
  format_stat_tab(n.digits = 3) |> 
  create_html_DT()
```
